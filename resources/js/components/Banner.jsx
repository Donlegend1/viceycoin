...
export default function Banner() {
  ...
  return (
    ...
    <div className="a">
      <div className="ha qb _d">
        <div className="jc ng">
          ...
          <h1 className="pa li pi ui yi vl bo">
          Viceycoin - The Future of Digital Currency
        </h1>
        <p className="la pa gd gi qi xi vl">
          Introducing Viceycoin, a revolutionary cryptocurrency designed for secure, fast, and low-cost transactions. Be part of the future of finance with our innovative blockchain technology.  
          NexaCoin is now available for purchase in our exclusive pre-sale. Don't miss this opportunity to invest in the next big thing in digital assets!
        </p>

            <div className="ma ra qb _d be de jm">
              <div className="sk e db eh xm">
                <span className="eb qb ac pc be de oe kf">
                ...
                <div className="d s t/2 ba rd/2 le oe rf _g tg zi fj uk">
                  <span className="d u t/2 bc qc rd/2 sd rf" />
            ...
            <a href="javascript:void(0)" className="oe of zg wg ii oi zi hk dark:hover:bg-opacity-90">
              Buy Tokens 47% Off
            </a>
          </div>
        </div>
    ...
    <div className="d f l ea yb jc gj" style={{"background-image":"linear-gradient(          180deg,          #3e7dff 0%,          rgba(62, 125, 255, 0) 100%        )"}} />
    <img src="/images/shapes/hero-shape-1.svg" alt className="d l f ea" />
    <img src="/images/shapes/hero-shape-2.svg" alt className="d m f ea" />
  </section>
  );
}
