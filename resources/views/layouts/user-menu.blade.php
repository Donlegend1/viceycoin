            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/live-trading" aria-expanded="false"><i
                                    class="fa fa-table"></i><span class="hide-menu">Live Trading</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="/demo-trading" aria-expanded="false"><i
                                    class="fa fa-smile-o"></i><span class="hide-menu">Demo Trading</span></a>
                        </li>
